...
val_node_ratio = 0.1
test_node_ratio = 0.2
network_params = {'conv_block': 'GCN',  # not implemented for GAT, which requires iter specific parameters
                  'hidden_dim': 128,
                  'dropout': 0.25}
...
if __name__ == '__main__':
    ...
    for num_layers in num_layers_list:  # loop through number of iterations
        ...
        log_folder = log_folder_master + \
                     '/SG_{}{}'.format(network_params['conv_block'], network_params['num_layers']) + \
